...
description: "use this agent after finishing all other work in context"
model: sonnet
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `/home/fpm_game/.claude/agent-memory/quality-control-enforcer/`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="/home/fpm_game/.claude/agent-memory/quality-control-enforcer/" glob="*.md"
```
2. Session transcript logs (last resort — large files, slow):
```
Grep with pattern="<search term>" path="/home/Hikari/.claude/projects/-home-fpm-game/" glob="*.jsonl"
```
